...
public class DBManager {
     ...
     * @param
     */
    public void saveToAlbum(List<Album> albums, long categoryID, int pageID) {
...
//    }
    ...
    public boolean hasLocalAudio() {
        return DaoManager.getInstance().hasLocalAudio();
    }
    ...
    public List<Audio> findLocalAudioForSearch(String audioName, String artists, String albumName) {
        return DaoManager.getInstance().findLocalAudioForSearch(audioName, artists, albumName);
    }
    ...
    public List<BreakpointAudio> findBreakpoint(Album album) {
        return DaoManager.getInstance().findBreakpoint(album);
    }

    public BreakpointAudio findBreakpoint(Album album, Audio audio) {
        return DaoManager.getInstance().findBreakpoint(album, audio);
    }
...
//    }
    ...
    public void removePlayItem(Audio audio) {
        DaoManager.getInstance().removePlayItem(audio);
    }
    ...
    public void saveMusicHistory(Album album, Audio audio) {
        DaoManager.getInstance().saveMusicHistory(album, audio);
    }

    public void saveAlbumHistory(Album album, Audio audio) {
//        if (audio != null) {
//            if (audio.getAlbum() != null) {
//                album = audio.getAlbum();//存放实际的音频，车主FM
//            }
//        }
    ...
    public HistoryData findlasterMusicHistory() {
        return DaoManager.getInstance().findlasterMusicHistory();
    }
...
//    因为HistoryData 必须通过long（key）来删除，这里有问题，获取不到historyData的id（自增）
//    public void deleteHistorys(List<HistoryData> historyData) {
//        DaoManager.getInstance().deleteHistorys(historyData);
//    }


    public List<Audio> convertHistoryDataToAudios(List<HistoryData> historyData) {
        List<Audio> audios = new ArrayList<>();
        for (HistoryData data : historyData) {
            if (data.getType() == HistoryData.TYPE_AUDIO) {
                audios.add(convertHistoryDataToAudio(data));
            }
        }
        return audios;
    }

    public Audio convertHistoryDataToAudio(HistoryData data) {
        if (data == null) {
            return null;
        }
    ...
    public PlayListData findPlayListData() {
        return DaoManager.getInstance().findPlayListData();
    }

    public void updatePlayListData(PlayListData playListData) {
        DaoManager.getInstance().updatePlayListData(playListData);
    }

    public void updatePlayListData(Audio audio) {
        DaoManager.getInstance().updatePlayListData(audio);
    }
