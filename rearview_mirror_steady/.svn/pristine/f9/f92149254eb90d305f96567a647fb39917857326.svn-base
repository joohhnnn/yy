...
public class WinLayoutFullH extends IWinLayout {
	...
	private void initSize(){
        ...
        tvHintTop = unit;
        tvHintSize = (int) LayouUtil.getDimen("h6");
	...
	public void init() {
		...
		if(fRootLayout == null){
			...
			//fLayoutParams.bottomMargin = (int)LayouUtil.getDimen("x20");
			...
			rllayoutParams = new RelativeLayout.LayoutParams((int) LayouUtil.getDimen("x133"),(int) LayouUtil.getDimen("x147"));
			...
			/*Button btnShow = new Button(GlobalContext.get());
			btnShow.setText("显示");
			btnShow.setOnClickListener(new View.OnClickListener() {
				@Override
				public void onClick(View v) {
					LogUtil.logd(WinLayout.logTag+ "SDKFloatView onClick: ");
					TXZConfigManager.getInstance().showFloatTool(TXZConfigManager.FloatToolType.FLOAT_TOP);
				}
			});
			rllayoutParams = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,ViewGroup.LayoutParams.WRAP_CONTENT);
			rllayoutParams.addRule(RelativeLayout.ALIGN_PARENT_TOP);
			mRecordRoot.addView(btnShow,rllayoutParams);
			Button btnHide = new Button(GlobalContext.get());
			btnHide.setText("隐藏");
			...
			rllayoutParams = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,ViewGroup.LayoutParams.WRAP_CONTENT);
			rllayoutParams.addRule(RelativeLayout.ALIGN_PARENT_TOP);
			rllayoutParams.leftMargin = (int) LayouUtil.getDimen("x100");
			mRecordRoot.addView(btnHide,rllayoutParams);*/
