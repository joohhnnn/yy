...
public class ReminderListView extends IReminderListView {
	...
	private void initFull(){
		...
		if (WinLayout.isVertScreen){
            ...
            ivIconSize = (int) LayouUtil.getDimen("vertical_h2");
            tvTimeSize = (int) LayouUtil.getDimen("vertical_h6");
            tvTimeHeight = (int) LayouUtil.getDimen("vertical_h6_height");
            ...
            ivIconSize = (int) LayouUtil.getDimen("h2");
            tvTimeSize = (int) LayouUtil.getDimen("h6");
            tvTimeHeight = (int) LayouUtil.getDimen("h6_height");
            tvTimeLeftMargin = unit;
		}
	}
	...
	private void initNone(){
        if (WinLayout.isVertScreen){
            ...
            tvNumHorMargin = (int) LayouUtil.getDimen("x20");
            tvNumSize = (int) LayouUtil.getDimen("x36");
            tvContentSize = (int) LayouUtil.getDimen("x25");
            tvContentHeight = tvContentSize + 10;
            ivIconSize = (int) LayouUtil.getDimen("x30");
            tvTimeSize = (int) LayouUtil.getDimen("x21");
            tvTimeHeight = tvTimeSize + 10;
            tvTimeLeftMargin = (int) LayouUtil.getDimen("x10");
        }else {
            int unit = (int) LayouUtil.getDimen("unit");
            tvNumSide = 6 * unit;
            tvNumHorMargin = 2 * unit;
            ...
            ivIconSize = (int) LayouUtil.getDimen("h2_none");
            tvTimeSize = (int) LayouUtil.getDimen("h6_none");
            tvTimeHeight = (int) LayouUtil.getDimen("h6_height_none");
            tvTimeLeftMargin = unit;
        }
	}
