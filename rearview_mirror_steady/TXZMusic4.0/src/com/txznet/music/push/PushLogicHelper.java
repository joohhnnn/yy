...
public class PushLogicHelper {
     ...
     */
    private boolean isExecuteShowView = false;
    ...
    public boolean isExecuteShowView() {
        return isExecuteShowView;
    }

    public void setExecuteShowView(boolean excuteShowView) {
        isExecuteShowView = excuteShowView;
    }
}
