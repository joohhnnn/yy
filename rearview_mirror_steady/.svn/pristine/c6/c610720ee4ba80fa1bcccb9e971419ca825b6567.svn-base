...
public class AnimVerticalView extends IImageView {
	private static final String TAG = AnimVerticalView.class.getSimpleName();
	...
	/*public AnimVerticalView(AbsStepView parentView, Context context) {
		super(context);
		init();
	}*/

	public AnimVerticalView(Context context) {
		super(context);
		LogUtil.logd(WinLayout.logTag+ "AnimVerticalView:init " );
		init();
	}
	...
	private void init(){
		...
		this.setImageDrawable(LayouUtil.getDrawable("vertical_report_00000"));
	}
	...
	private void initReportAnim(){
		...
		for(int i =0;i < 13;i+=2){
			if (i < 10){
				name = "vertical_report_0000" + i;
			}else {
				name = "vertical_report_000" + i;
			}
	...
	private void initListeningAnim(){
		...
		for(int i =0;i < 15;i+=2){
			if (i < 10){
				name = "vertical_listening_0000" + i;
			}else {
				name = "vertical_listening_000" + i;
			}
			Drawable drawable = LayouUtil.getDrawable(name);
