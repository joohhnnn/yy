...
//            tempAudio.setStrDownloadUrl(getFinalFile() == null ? mAudio.getStrDownloadUrl() : getFinalFile().getAbsolutePath());
            tempAudio.setStrDownloadUrl(mAudio.getStrDownloadUrl());
            tempAudio.setStrProcessingUrl(mAudio.getStrProcessingUrl());
            ...
            tempAudio.setSourceFrom(mAudio.getSourceFrom());
            tempAudio.setDownloadType(mAudio.getDownloadType());
        }
    }
