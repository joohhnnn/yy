...
//import com.txznet.music.baseModule.dao.interfase.BaseDaoImpl;
//import com.txznet.music.baseModule.net.request.ReqDataStats;
//import com.txznet.music.historyModule.db.HistoryAudioDBHelper;
//import com.txznet.music.localModule.db.LocalAudioDBHelper;
...
//                TtsUtilWrapper.speakTextOnRecordWin("RS_VOICE_SPEAK_NETNOTCON_TIPS",
...
//        } catch (Exception e) {
//            e.printStackTrace();
//            TtsUtilWrapper.speakResource("RS_VOICE_SPEAK_JSONERR_TIPS", Constant.RS_VOICE_SPEAK_JSONERR_TIPS);
//            return;
//        }
...
//                TtsUtilWrapper.speakTextOnRecordWinWithCancle("RS_VOICE_SPEAK_WILL_PLAY",
