...
public class AnimNoneView extends IImageView {
	...
	/*public AnimNoneView(AbsStepView parentView, Context context) {
		super(context);
		init();
	}*/
	...
	private void initReportAnim(){
		...
		for(int i =0;i < 13;i+=2){
			if (i < 10){
				name = "none_report_0000" + i;
			}else {
				name = "none_report_000" + i;
			}
	...
	private void initListeningAnim(){
		...
		for(int i =0;i < 15;i+=2){
			if (i < 10){
				name = "none_listen_0000" + i;
			}else {
				name = "none_listen_000" + i;
			}
			Drawable drawable = LayouUtil.getDrawable(name);
