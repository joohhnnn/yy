...
public class DBUtils {
	...
	public static final int DATABASE_VERSION = 26;// 数据库版本
	...
	public SQLiteDatabase openGlobe() {
		// 这里有可能有问题：：：当系统空间不足的情况下
		return dataReadBaseHelper_globe.getReadableDatabase();
	}
	...
	public SQLiteDatabase openReadGlobe() {
		//TODO: android.database.sqlite.SQLiteCantOpenDatabaseException: unknown error (code 14): Could not open database
