...
public class CallListView extends ICallListView {
	...
	private void initFull(){
		if (WinLayout.isVertScreen){
            ...
            tvDeatilHeight = (int) LayouUtil.getDimen("vertical_h7_height");
            tvDeatilSize = (int) LayouUtil.getDimen("vertical_h7");
		}else {
            ...
            tvDeatilHeight = (int) LayouUtil.getDimen("h7_height");
            tvDeatilSize = (int) LayouUtil.getDimen("h7");
		}
	}
	...
	private void initNone(){
        if (WinLayout.isVertScreen){
            ...
            tvNameBgSide = (int) LayouUtil.getDimen("x73");
            tvNameRightMargin = (int) LayouUtil.getDimen("x10");
            tvNameSize = (int) LayouUtil.getDimen("x51");
            tvContentSize = (int) LayouUtil.getDimen("x25");
            tvContentHeight = tvContentSize + 10;
            tvDeatilSize = (int) LayouUtil.getDimen("x18");
            tvDeatilHeight = tvDeatilSize + 10;
        }else {
            int unit = (int) LayouUtil.getDimen("unit");
            tvNumSide = 6 * unit;
            tvNumHorMargin = 2 * unit;
            ...
            tvDeatilHeight = (int) LayouUtil.getDimen("h7_height_none");
            tvDeatilSize = (int) LayouUtil.getDimen("h7_none");
        }
	}
