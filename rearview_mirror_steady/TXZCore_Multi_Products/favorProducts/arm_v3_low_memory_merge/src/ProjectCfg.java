...
//		}
	...
	private static boolean sWakeupPrebuiltGrammar = true;
	...
	private static int sMemMode = MEM_MODE_PREBUILD_MERGE;
	
	private final static int[] sMemModeListSupported = {MEM_MODE_NONE, MEM_MODE_PREBUILD_MERGE};
   ...
   //默认使用预处理之后的数据
    ...
    //是否默认使用2.0的皮肤包，低内存版本默认不使用
	public static final Boolean DEFAULT_USE_2_0 = false;
