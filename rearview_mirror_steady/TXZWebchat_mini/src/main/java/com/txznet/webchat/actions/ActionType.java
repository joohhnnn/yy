...
public interface ActionType {
    ...
    String WX_CONTROL_ENABLE = "wx_control_enable"; // 远程控制入口开启
    String WX_CONTROL_DISABLE = "wx_control_disable"; // 远程控制入口关闭
    ...
    String WX_SERVER_CONFIG_REQ = "wx_server_config_req"; // 请求远程配置数据
