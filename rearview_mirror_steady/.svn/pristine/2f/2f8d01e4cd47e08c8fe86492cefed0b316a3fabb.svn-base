...
public class WxConfigSp extends CommonSp {
    ...
    private static final String KEY_CONTROL_ENTRY = "key_enable_control_entry";
    ...
    private static final String KEY_WX_CLOSE_DESC = "key_wx_close_desc";
    ...
    public void setWxControlEnabled(boolean value) {
        setValue(KEY_CONTROL_ENTRY, value);
    }

    public boolean getWxControlEnabled(boolean defValue) {
        return getValue(KEY_CONTROL_ENTRY, defValue);
    }
    ...
    public void setWxCloseDesc(String wxCloseDesc) {
        setValue(KEY_WX_CLOSE_DESC, wxCloseDesc);
    }

    public String getWxCloseDesc(String defValue) {
        return getValue(KEY_WX_CLOSE_DESC, defValue);
    }
}
