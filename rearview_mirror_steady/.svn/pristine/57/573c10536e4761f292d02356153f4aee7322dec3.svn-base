	...
	public void init() {
		...
		normalRun = new Runnable() {
			...
			public void run() {
				...
				animationView.setImageDrawable(LayouUtil.getDrawable("none_report_00015"));
		...
		recordRun = new Runnable() {
			...
			public void run() {
				//animationView.playEndAnim(0);
				animationView.setImageDrawable(LayouUtil.getDrawable("none_listen_00028"));
			}
		};
		...
		endRun = new Runnable() {
			...
			public void run() {
				//animationView.playEndAnim(1);
				animationView.setImageDrawable(LayouUtil.getDrawable("none_handle_00018"));
