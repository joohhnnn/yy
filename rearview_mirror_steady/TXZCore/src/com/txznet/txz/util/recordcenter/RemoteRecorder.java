...
public class RemoteRecorder implements ITXZRecorder {
	...
	public RemoteRecorder(int audioSource, int sampleRateInHz, int channelConfig, int audioFormat, int bufferSizeInBytes) {
	...
	private void connectService() {
		...
		//5.0以后的版本需要显式调用
		final String pkgName = ProjectCfg.ext_audiosource_pkg;
		if (!TextUtils.isEmpty(pkgName)){
			JNIHelper.logd("ext_audiosource_pkg : " + pkgName);
