...
public class Error implements Parcelable {
    ...
    11 需要网络才能发送请求
     */
    public static final int ERROR_CORE_NET_NO_SERVER = SOURCE_CORE * ERROR_CODE_BASE + 1;
    public static final int ERROR_CORE_SERVER_TIMEOUT = SOURCE_CORE * ERROR_CODE_BASE + 2;
    public static final int ERROR_CORE_SERVER_OVERLOAD = SOURCE_CORE * ERROR_CODE_BASE + 3;
    public static final int ERROR_CORE_REQUEST_QUEUE_FULL = SOURCE_CORE * ERROR_CODE_BASE + 4;
    public static final int ERROR_CORE_NO_LOGIN = SOURCE_CORE * ERROR_CODE_BASE + 5;
    public static final int ERROR_CORE_SERVER_BUSY = SOURCE_CORE * ERROR_CODE_BASE + 6;
    public static final int ERROR_CORE_PROTOCOL_RESOLUTION_FAILURE = SOURCE_CORE * ERROR_CODE_BASE + 7;
    public static final int ERROR_CORE_PARAM_ERROR = SOURCE_CORE * ERROR_CODE_BASE + 8;
    public static final int ERROR_CORE_NET_TIMEOUT = SOURCE_CORE * ERROR_CODE_BASE + 9;
    public static final int ERROR_CORE_REQUEST_ERROR = SOURCE_CORE * ERROR_CODE_BASE + 10;
    public static final int ERROR_CORE_NOT_NET = SOURCE_CORE * ERROR_CODE_BASE + 11;
    ...
    //文件在播放的过程中路径发生变化
    public static final int ERROR_CLIENT_MEDIA_URL_CHANGE = SOURCE_CLIENT * ERROR_CODE_BASE + 116;

    public static final int ERROR_GET_PLAY_ITEM_TIMEOUT = SOURCE_CLIENT * ERROR_CODE_BASE + 117;

    public static final int ERROR_CLIENT_QUERY_ALBUM_ERROR = SOURCE_CLIENT * ERROR_CODE_BASE + 118; //请求Album返回错误

    public static final int ERROR_CLIENT_QUERY_CATEGORY_ERROR = SOURCE_CLIENT * ERROR_CODE_BASE + 119; //请求category返回出错

    public static final int ERROR_CLIENT_PLAYER_LIST_END = SOURCE_CLIENT * ERROR_CODE_BASE + 120; //播放列表播放到结尾

    public static final int ERROR_CLIENT_JSON_PARSER = SOURCE_SERVER * ERROR_CODE_BASE + 1;//json解析错误

    public static final int ERROR_DECODE_JSON_PARSER = SOURCE_DECODE * ERROR_CODE_BASE + 1;//创建AudioTrack失败
