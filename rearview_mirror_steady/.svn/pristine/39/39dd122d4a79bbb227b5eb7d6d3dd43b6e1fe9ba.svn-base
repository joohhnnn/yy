...
public class Error implements Parcelable {
    ...
    public static final int ERROR_CLIENT_REQUEST_URL = SOURCE_SERVER * ERROR_CODE_BASE + 2;//请求网易云连接异常

    public static final int ERROR_CLIENT_REQUEST_TIMEOUT = SOURCE_SERVER * ERROR_CODE_BASE + 3;//请求网易云连接异常
