...
public class ListTitleView extends IListTitleView{
    ...
    private void initFull(){
        if (WinLayout.isVertScreen){
            ...
            trafficLineWidth = 8 * unit;
            trafficLineHeight = 3 * unit;    //票务连接线高度
            tvTitleSize = (int) LayouUtil.getDimen("vertical_h4");
            tvPreFixSize = (int) LayouUtil.getDimen("vertical_h5");
            tvAftFixSize = (int) LayouUtil.getDimen("vertical_h3");
            tvCitySize = (int) LayouUtil.getDimen("vertical_h3");
            tvPrePagerSize = (int) LayouUtil.getDimen("vertical_h5");
            tvCurPagerSize = (int) LayouUtil.getDimen("vertical_h5");
            tvNextPagerSize = (int) LayouUtil.getDimen("vertical_h5");
			llTitleViewPaddingLeft = unit;
			llTitleViewPaddingRight = 0;
        }else {
            ...
            trafficLineWidth = 8 * unit;
            trafficLineHeight = 3 * unit;    //票务连接线高度
            tvTitleSize = (int) LayouUtil.getDimen("h4");
            tvPreFixSize = (int) LayouUtil.getDimen("h5");
            tvAftFixSize = (int) LayouUtil.getDimen("h3");
            tvCitySize = (int) LayouUtil.getDimen("h3");
            tvPrePagerSize = (int) LayouUtil.getDimen("h5");
            tvCurPagerSize = (int) LayouUtil.getDimen("h5");
            tvNextPagerSize = (int) LayouUtil.getDimen("h5");
    ...
    private void initNone(){
        if (WinLayout.isVertScreen){
            //int unit = (int) LayouUtil.getDimen("vertical_unit");
            iconWidth = (int) LayouUtil.getDimen("x61");
            iconHeight = (int) LayouUtil.getDimen("x61");
            iconMarginLeft = (int) LayouUtil.getDimen("x10");
            iconMarginRight = (int) LayouUtil.getDimen("x10");
            trafficNameMargin = (int) LayouUtil.getDimen("x10");    //票务名称边距
            trafficLineMargin = (int) LayouUtil.getDimen("xx5");    //票务连接线边距
            trafficLineWidth = (int) LayouUtil.getDimen("x83");
            trafficLineHeight = (int) LayouUtil.getDimen("x31");    //票务连接线高度
            tvTitleSize =  (int) LayouUtil.getDimen("x25");
            tvPreFixSize = (int) LayouUtil.getDimen("x23");
            tvAftFixSize = (int) LayouUtil.getDimen("x16");
            tvCitySize = (int) LayouUtil.getDimen("x26");
            tvPrePagerSize = (int) LayouUtil.getDimen("x23");
            tvCurPagerSize = (int) LayouUtil.getDimen("x23");
            tvNextPagerSize = (int) LayouUtil.getDimen("x23");
			llTitleViewPaddingLeft = (int) LayouUtil.getDimen("x10");
			//llTitleViewPaddingRight = (int) LayouUtil.getDimen("x10");
			llTitleViewPaddingRight = 0;
        }else {
            ...
            trafficNameMargin = 2 * unit ;    //票务名称边距
            trafficLineMargin = unit;    //票务连接线边距
            //trafficLineWidth = (int) LayouUtil.getDimen("x75");
            trafficLineWidth = 8 * unit;
            //trafficLineHeight = (int) LayouUtil.getDimen("x28");    //票务连接线高度
            trafficLineHeight = 3 * unit;    //票务连接线高度
            tvTitleSize = (int) LayouUtil.getDimen("h4_none");
            tvPreFixSize = (int) LayouUtil.getDimen("h5_none");
            tvAftFixSize = (int) LayouUtil.getDimen("h3_none");
            tvCitySize = (int) LayouUtil.getDimen("h3_none");
            tvPrePagerSize = (int) LayouUtil.getDimen("h5_none");
            tvCurPagerSize = (int) LayouUtil.getDimen("h5_none");
            tvNextPagerSize = (int) LayouUtil.getDimen("h5_none");
			llTitleViewPaddingLeft = unit;
			llTitleViewPaddingRight = unit;
        }
    }
    ...
    private View createHelpTitleView(){
		...
		llTitleView.setOrientation(LinearLayout.HORIZONTAL);
		llTitleView.setGravity(Gravity.CENTER_VERTICAL);
		llTitleView.setPadding(llTitleViewPaddingLeft, 0, 0, 0);
