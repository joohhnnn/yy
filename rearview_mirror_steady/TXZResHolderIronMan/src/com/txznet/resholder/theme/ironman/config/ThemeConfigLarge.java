...
public class ThemeConfigLarge extends ThemeConfig {
	   
	static{
		configs.put("base_color1", ConfigUtil.getColorValue("#31DFFF"));
		configs.put("base_color2",  ConfigUtil.getColorValue("#6631DFFF"));
	...
	public ThemeConfigLarge() {
	    ...
	    LIST_ITEM_WEATHER_TITLE_MARGINTOP = 6;
	    LIST_ITEM_WEATHER_TITLE_MARGINBOTTOM = 0;
