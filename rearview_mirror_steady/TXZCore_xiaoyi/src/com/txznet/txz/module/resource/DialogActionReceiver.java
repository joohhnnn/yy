...
public class DialogActionReceiver extends BroadcastReceiver {
	...
	private void createDialog(final DialogInfo dialogInfo) {
		...
		}.setSureText(dialogInfo.sureText, new String[] { dialogInfo.sureText })
				.setCancelText(dialogInfo.cancelText,
						new String[] { dialogInfo.cancelText })
				.setMessage(dialogInfo.message).setHintTts(dialogInfo.message);
