...
//		}
	...
	private static boolean enableUpdateKeywords = false;
	public static boolean enableUpdateKeywords() {
		return enableUpdateKeywords;
	}
	
	public static void setEnableUpdateKeywords(boolean enable) {
		enableUpdateKeywords = enable;
	}
