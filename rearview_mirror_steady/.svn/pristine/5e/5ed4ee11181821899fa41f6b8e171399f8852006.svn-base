...
public class RecordAnimView extends View {
	...
	String[] mDrawablesId = { "ic_recording1", "ic_recording2", "ic_recording3",
			"ic_recording4", "ic_recording5","ic_recording6" };

	// private int[] index = { 0, 0, 0, 0, 0, 0 };
	// float[][] mDrawableScaleY = {
	// { 0.05f, 0.1f, 0.2f, 0.3f, 0.4f, 0.6f, 0.9f, 1, 0.9f, 0.8f, 0.7f, 0.6f,
	// 0.4f, 0.3f, 0.3197568f, 0.3383292f,
	// 0.363f, 0.3780892f, 0.39479682f, 0.412f, 0.43184918f, 0.4533168f,
	// 0.47500002f, 0.4996092f,
	// 0.5258368f, 0.55200005f, 0.58136916f, 0.6123568f, 0.643f, 0.6771292f,
	// 0.7128768f, 0.748f,
	// 0.7868892f, 0.82739675f, 0.867f, 0.91064924f, 0.9559168f, 1.0f },
	// { 0.05f, 0.1f, 0.2f, 0.3f, 0.4f, 0.6f, 0.9f, 1, 0.9f, 0.8f, 0.7f, 0.6f,
	// 0.4f, 0.4f, 0.40661502f,
	// 0.41283345f, 0.42109376f, 0.42614594f, 0.43174002f, 0.4375f, 0.44414595f,
	// 0.45133376f, 0.45859376f,
	// 0.46683344f, 0.475615f, 0.484375f, 0.49420846f, 0.5045838f, 0.51484376f,
	// 0.526271f, 0.53824f, 0.55f,
	// 0.56302094f, 0.57658374f, 0.58984375f, 0.60445845f, 0.619615f,
	// 0.63437504f, 0.6505835f, 0.6673338f,
	// 0.68359375f, 0.701396f, 0.71974003f, 0.7375f, 0.75689596f, 0.7768338f,
	// 0.79609376f, 0.8170835f,
	// 0.83861506f, 0.859375f, 0.8819585f, 0.9050838f, 0.9273437f, 0.9515209f,
	// 0.97624004f, 1.0f },
	// { 0.05f, 0.1f, 0.2f, 0.3f, 0.4f, 0.6f, 0.9f, 1, 0.9f, 0.8f, 0.7f, 0.8f,
	// 0.3f, 0.3f, 0.31008002f,
	// 0.31955573f, 0.33214286f, 0.33984146f, 0.34836572f, 0.35714287f,
	// 0.36727002f, 0.37822288f,
	// 0.3892857f, 0.40184143f, 0.41522285f, 0.42857143f, 0.4435557f,
	// 0.45936573f, 0.47500002f,
	// 0.49241287f, 0.5106514f, 0.5285715f, 0.54841286f, 0.56908f, 0.58928573f,
	// 0.6115557f, 0.6346514f,
	// 0.6571429f, 0.6818414f, 0.70736575f, 0.7321428f, 0.75926995f,
	// 0.78722286f, 0.8142857f, 0.8438415f,
	// 0.8742228f, 0.90357137f, 0.93555576f, 0.9683657f, 1.0f },
	// { 0.05f, 0.1f, 0.2f, 0.3f, 0.4f, 0.6f, 0.9f, 1, 0.9f, 0.8f, 0.7f, 0.6f,
	// 0.5f, 0.4f, 0.4f, 0.44704002f,
	// 0.49126f, 0.55f, 0.58592665f, 0.6257067f, 0.66666675f, 0.7139267f,
	// 0.76504f, 0.81666666f, 0.87526f,
	// 0.9377067f, 1.0f },
	// { 0.05f, 0.1f, 0.2f, 0.3f, 0.4f, 0.6f, 0.9f, 1, 0.9f, 0.8f, 0.7f, 0.6f,
	// 0.3f, 0.3f, 0.33087f, 0.3598894f,
	// 0.3984375f, 0.4220144f, 0.44812f, 0.47500002f, 0.5060144f, 0.5395575f,
	// 0.5734375f, 0.61188936f,
	// 0.65286994f, 0.69375f, 0.7396394f, 0.78805745f, 0.8359375f, 0.8892644f,
	// 0.94512f, 1.0f },
	// { 0.05f, 0.1f, 0.2f, 0.3f, 0.4f, 0.6f, 0.9f, 1, 0.9f, 0.8f, 0.7f, 0.6f,
	// 0.3f, 0.3f, 0.32439113f,
	// 0.34732002f, 0.37777779f, 0.39640644f, 0.41703308f, 0.4382716f,
	// 0.4627768f, 0.48928f, 0.5160494f,
	// 0.54643106f, 0.5788109f, 0.61111116f, 0.6473694f, 0.6856257f, 0.7234568f,
	// 0.7655916f, 0.80972445f,
	// 0.8530864f, 0.9010978f, 0.9511072f, 1.0f } };
	// private int[] length = { mDrawableScaleY[0].length,
	// mDrawableScaleY[1].length, mDrawableScaleY[2].length,
	// mDrawableScaleY[3].length, mDrawableScaleY[4].length,
	// mDrawableScaleY[5].length };
	...
	public void release() {
		LogUtil.logd("RecordAnimView release");
		// removeCallbacks(mDrawVoiceRunnable);
		// removeCallbacks(mDrawLineRunnable);
		UI2Manager.removeUIThread(mDrawLineRunnable);
		UI2Manager.removeUIThread(mDrawVoiceRunnable);
	}

	public RecordAnimView(AbsStepView parentView, Context context) {
		super(context);
		this.parentView = parentView;
		mDefaultWidth = LayouUtil.getDimen("x230");
		init(context);
	}
...
//			removeCallbacks(mDrawVoiceRunnable);
			UI2Manager.removeUIThread(mDrawVoiceRunnable);
			UI2Manager.runOnUIThread(mDrawVoiceRunnable, 55);
//			postDelayed(mDrawVoiceRunnable, 55);
	...
	private Runnable mDrawLineRunnable = new Runnable() {
		...
		public void run() {
			...
			UI2Manager.removeUIThread(mDrawLineRunnable);
			UI2Manager.runOnUIThread(mDrawLineRunnable, 25);
		}
	};
...
//		post(mDrawLineRunnable);
		UI2Manager.runOnUIThread(mDrawLineRunnable, 0);
...
//			post(mDrawVoiceRunnable);
			UI2Manager.runOnUIThread(mDrawVoiceRunnable, 0);
			if (parentView.mListener != null) {
	...
	class RecordDrawable {
		...
		public RecordDrawable(String resId) {
			drawable = LayouUtil.getDrawable(resId);
