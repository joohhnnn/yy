...
public class ItemAlbumSingerAdapter extends ItemAlbumBaseAdapter {
    ...
    public ItemAlbumSingerAdapter(Context ctx, Fragment fragment, List<Album> albums) {
        super(ctx, albums);
    ...
    public void onChildBindViewHolder(RecyclerView.ViewHolder holder, Album album) {
        ...
        ImageFactory.getInstance().display(mFragment, album.getLogo(), viewHolder.ivType, R.drawable.fm_item_default);
