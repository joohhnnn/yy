...
public class NetCacheManager {
    ...
    public int requestCache(String url, Object requestParam, RequestCallBack requestCallBack) {
        return NetManager.getInstance().sendRequestToCore(url, requestParam,requestCallBack);
//
//
...
//        }
    ...
    public void saveDataToFile(File file, String data) {
