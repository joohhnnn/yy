...
import com.txznet.nav.offline.OfflineMapDownloadManager.OnPrepareDoneListener;
import com.txznet.nav.ui.widget.CityItemView;
import com.txznet.nav.ui.widget.CityItemView.OnMapListener;

public class DownloadingWin {
	...
	private static DownloadingWin instance = new DownloadingWin();

	private DownloadingWin() {
	}

	public static DownloadingWin getInstance() {
		return instance;
	}
	...
	public void init(View view) {
		...
		OfflineMapDownloadManager.getInstance().registerDownloadDoneListener(
				new OnPrepareDoneListener() {
...
//		});
	...
	private class ExpandAdapter extends BaseExpandableListAdapter {
		...
		public Object getGroup(int groupPosition) {
			...
			String omp = mProvNames.get(groupPosition);
			if (omp == null) {
				return "";
			}
		...
		public View getChildView(final int groupPosition,
			...
			if (convertView == null) {
				...
				((CityItemView) convertView)
						.setMode(CityItemView.MODE_DOWNLOAD);
			}
