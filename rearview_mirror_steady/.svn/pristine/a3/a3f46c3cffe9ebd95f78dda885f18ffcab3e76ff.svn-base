...
public class MigrationHelper {
    ...
    public static void addTextColumn(Database db, String tableName, String columnName, String defaultValue) {
        try {
            db.execSQL(String.format(Locale.getDefault(), "ALTER table %s ADD COLUMN %s %s default '%s'", tableName, columnName, "TEXT", defaultValue));
        } catch (Throwable throwable) {
        }
    }

    public static void removeColumn(Database db, String tableName, String columnName) {
//        db.execSQL(String.format(Locale.getDefault(), "ALTER table %s DROP COLUMN %s ", tableName, columnName));
    }
