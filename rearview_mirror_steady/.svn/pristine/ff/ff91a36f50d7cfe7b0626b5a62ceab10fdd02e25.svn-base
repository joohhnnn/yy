...
public class AlbumViewHolder extends AlbumBaseViewHolder {
    ...
    private TextView tvIntro,tvHotIntro;
    private ShadeImageView ivType,ivHotType;
    private Resources mRes;
    private ImageView ivFocus;
    private ImageView ivPlaying;
    private LinearLayout mLlAlbum;
    private RelativeLayout mRlAlbum,mAlbumLl;
    ...
    public AlbumViewHolder(View itemView) {
        ...
        mAlbumLl = (RelativeLayout) itemView.findViewById(R.id.album_ll);
