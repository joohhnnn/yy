...
public class SelectCityView extends ISelectCityView {
    ...
    private View createContentView() {
       ...
       //rlLayoutParams = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, (int) LayouUtil.getDimen("y16"));
        ...
        tvPerCity.setPadding(listContentPadding, 0, 0, 0);
        ...
        Log.d("jack", "createContentView: "+mSelectCityViewData.curCityList.size()+"--"+mSelectCityViewData.perCityList.size()+"--"+
            mSelectCityViewData.nomCityList.size()+"--"+mSelectCityViewData.tarCityList.size());
    ...
    public void onStart(String s) {
        Log.d("jack", "onStart: SelectCityView"+s);

    }

    @Override
    public void onShow() {
        Log.d("jack", "onShow: SelectCityView");

    }

    @Override
    public void onDismiss() {
        Log.d("jack", "onDismiss: SelectCityView");
    }
