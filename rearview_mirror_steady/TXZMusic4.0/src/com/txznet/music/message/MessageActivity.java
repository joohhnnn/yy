...
public class MessageActivity extends BaseBarActivity implements Observer {
    ...
    public int getLayout() {
        if (ScreenUtils.isPhonePortrait()) {
            return R.layout.activity_message_phone_portrait;
        }
    ...
    private void handleClick(Message message) {
        if (message.getType() == Message.TYPE_ALBUM) {
            ...
            AlbumEngine.getInstance().playAlbum(PlayInfoManager.DATA_MESSAGE, EnumState.Operation.manual, album, album.getCategoryId(), null);
