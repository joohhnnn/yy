...
public class ItemAlbumRankListAdapter extends ItemAlbumBaseAdapter {
    Fragment mFragment = null;

    public ItemAlbumRankListAdapter(Context ctx, Fragment fragment, List<Album> albums) {
        super(ctx, albums);
    ...
    public RecyclerView.ViewHolder onCreateChildViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_album_rank_list, parent, false);
