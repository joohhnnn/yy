...
public class CompetitionDetailView extends ICompetitionDetailView {
    ...
    private void initFull() {
        if (WinLayout.isVertScreen) {
            ...
            mH1 = (int) LayouUtil.getDimen("vertical_h1");
            mH4 = (int) LayouUtil.getDimen("vertical_h4");
            mH5 = (int) LayouUtil.getDimen("vertical_h5");
            mH7 = (int) LayouUtil.getDimen("vertical_h7");
        } else {
            unit = (int) LayouUtil.getDimen("unit");
            countHeight = SizeConfig.pagePoiCount * SizeConfig.itemHeight;
            detailVerMargin = 8 * unit;
            mH1 = (int) LayouUtil.getDimen("h1");
            mH4 = (int) LayouUtil.getDimen("h4");
            mH5 = (int) LayouUtil.getDimen("h5");
            mH7 = (int) LayouUtil.getDimen("h7");
        }
