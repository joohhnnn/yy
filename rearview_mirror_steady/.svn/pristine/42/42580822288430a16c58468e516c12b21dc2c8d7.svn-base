...
public class NoTtsQrcodeView extends INoTtsQrcodeView{
	...
	private View createTopView() {
		...
		TextViewUtil.setTextSize(tvTitle,(Float) ViewConfiger.getInstance().getConfig(ViewConfiger.SIZE_TTS_INTRO_SIZE1));
		TextViewUtil.setTextColor(tvTitle,(Integer) ViewConfiger.getInstance().getConfig(ViewConfiger.COLOR_TTS_INTRO_COLOR1));
		tvTitle.setBackground(LayouUtil.getDrawable("title_bg"));
		tvTitle.setPadding((int)LayouUtil.getDimen("x15"),(int)LayouUtil.getDimen("y5"), (int)LayouUtil.getDimen("x15"), (int)LayouUtil.getDimen("y12"));
		return tvTitle;
	}
	...
	private View createQRCodeView() {
		...
		qrContainer.setBackground(LayouUtil.getDrawable("qr_bg"));
		qrContainer.setPadding((int)LayouUtil.getDimen("y20"), (int)LayouUtil.getDimen("y20"), (int)LayouUtil.getDimen("y20"), (int)LayouUtil.getDimen("y20"));
