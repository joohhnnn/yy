...
public class Car_MainActivity extends AppBaseActivity {
    ...
    private static final String INTENT_DATA_OPEN_HELP = "open_help";
    ...
    CarSessionListAdapter mSessionListAdapter;
    ...
    protected int getLayout() {
        ...
        if (WxThemeStore.THEME_CAR_PORTRAIT.equals(theme)) {
            return R.layout.activity_car_main_portrait;
        }
    ...
    private boolean bBindPanelFocused = false;
    ...
    private void refreshFocusListOneWay() {
        ...
        if (bSettingsShowing) {
            if (bHelpPanelFocused) {
                vList.add(mBtnHelpExpand);
                vList.add(mElvHelp);
            } else if (bBindPanelFocused) {
                vList.add(mBtnBindRefresh);
            } else {
        ...
        if (WxNavBtnHelper.getInstance().isNavBtnTriggered()) {
            if (bSettingsShowing) {
                if (bHelpPanelFocused) {
                    ...
                    getNavBtnSupporter().setCurrentFocus(mBtnBindRefresh);
                } else {
                ...
                if (bChatPanelFocused) {
                    ...
                    } else if (null == getNavBtnSupporter().getCurrentFocus()) {
                        // 只在当前无方控焦点的情况下自动将焦点设置到设置按钮, 避免其他界面元素更新导致焦点
                        // 异常变动
    ...
    private void refreshFocusListTwoWay() {
        ...
        if (bSettingsShowing) {
            ...
            if (bHelpPanelFocused) {
                ...
                mBtnHelpExpand.setNextFocusDownId(mElvHelp.getId());
                mElvHelp.setNextFocusUpId(mBtnHelpExpand.getId());
            } else if (bBindPanelFocused) {
                vList.add(mBtnBindRefresh);
                mElvHelp.setNextFocusRightId(mBtnBindRefresh.getId());
                mBtnBindRefresh.setNextFocusLeftId(mElvHelp.getId());
            }
        } else {
            vList.add(mBtnMenuToggle);
            vList.add(mRvSessionList);
    ...
    private void initTheme() {
        mBtnMenuToggle.setIconNormal(
                getResources().getDrawable(R.drawable.src_car_main_setting));
        mBtnMenuToggle.setIconPressed(
                getResources().getDrawable(R.drawable.src_car_main_setting_pressed));
        mBtnChatReply.setBackground(
                getResources().getDrawable(R.drawable.selector_car_record_btn_bg));

        mRlRoot.setBackground(
                getResources().getDrawable(R.drawable.shape_activity_background_main));
        mFlChatTitle.setBackground(
                getResources().getDrawable(R.drawable.shape_activity_background_main_title));
        mViewChatBackground.setBackground(
                getResources().getDrawable(R.drawable.shape_activity_background_main_accent));
        mRlListHelp.setBackground(
                getResources().getDrawable(R.drawable.shape_activity_background_main_accent));

        mIvChatReplyIcon.setImageDrawable(
                getResources().getDrawable(R.drawable.ic_car_wechat_say));
    }
    ...
    private void resolveIntent(Intent intent) {
        ...
        } else if (INTENT_DATA_OPEN_HELP.equals(operation)) {
            // 如果设置页未开启, 先打开设置页面
            if (!bSettingsShowing) {
                changeMenuStatus();
            }
    ...
    public static void showHelp() {
        Intent intent = new Intent();
        intent.putExtra(INTENT_PARAM_OPERATION, INTENT_DATA_OPEN_HELP);
        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        intent.setClass(GlobalContext.get(), ReserveSingleTopActivity4.class);
        GlobalContext.get().startActivity(intent);
    }
    ...
    private void initSessionList() {
        ...
        mSessionListAdapter = new CarSessionListAdapter(this);
        ...
        mSessionListAdapter.setOnItemClickListener(new CarSessionListAdapter.OnItemClickListener() {
            @Override
    ...
    private void changeMenuStatus() {
        if (bSettingsShowing) {
            ...
            if (bHideBackButton) {
                ...
                // set icon
                mBtnMenuToggle.setText(getResources().getString(R.string.lb_car_main_menu_toggle));
                mBtnMenuToggle.setIconNormal(
                        getResources().getDrawable(R.drawable.src_car_main_setting));
                mBtnMenuToggle.setIconPressed(
                        getResources().getDrawable(R.drawable.src_car_main_setting_pressed));
            ...
            if (bHideBackButton) {
                ...
                // set icon
                mBtnMenuToggle.setText(getResources().getString(R.string
                        .lb_car_main_menu_toggle_back));
                mBtnMenuToggle.setIconNormal(
                        getResources().getDrawable(R.drawable.src_car_main_setting_back));
                mBtnMenuToggle.setIconPressed(
                        getResources().getDrawable(R.drawable.src_car_main_setting_back_pressed));
            }
    ...
    public void onBackPressed() {
        if (bSettingsShowing) {
            if ((bBindPanelFocused || bHelpPanelFocused) && WxNavBtnHelper.getInstance().isNavBtnTriggered()) {
                bHelpPanelFocused = false;
                bBindPanelFocused = false;
                refreshFocusViewList();
