...
public class SysPageCategoryItemClickEvent extends SysPageItemClickEvent {
    ...
    public SysPageCategoryItemClickEvent(@PageType int pageType, int posId, long categoryId) {
