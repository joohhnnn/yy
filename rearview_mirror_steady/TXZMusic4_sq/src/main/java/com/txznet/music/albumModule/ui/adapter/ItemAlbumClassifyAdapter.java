...
public class ItemAlbumClassifyAdapter extends ItemAlbumBaseAdapter {
    ...
    public ItemAlbumClassifyAdapter(BaseFragment baseFragment, List<Album> albums) {
    ...
    public void onChildBindViewHolder(RecyclerView.ViewHolder holder, Album album) {
        ...
        ImageFactory.getInstance().display(baseFragment, album.getLogo(), viewHolder.ivType, R.drawable.fm_item_default_2);
