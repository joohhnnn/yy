...
public class AnimHalfView extends IImageView {
	private static final String TAG = AnimHalfView.class.getSimpleName();
	...
	/*public AnimHalfView(AbsStepView parentView, Context context) {
		super(context);
		init();
	}*/

	public AnimHalfView(Context context) {
		super(context);
		LogUtil.logd(WinLayout.logTag+ "AnimHalfView:init " );
		init();
	}
	...
	private void init(){
		...
		this.setImageDrawable(LayouUtil.getDrawable("half_report_00000"));
	}
	...
	protected void onDraw(Canvas canvas) {
		try {
			...
			LogUtil.logd(WinLayout.logTag+ "onDraw():Canvas: trying to use a recycled bitmap " );
		}
	}*/
	...
	private void initReportAnim(){
		...
		for(int i =0;i < 13;i+=2){
			if (i < 10){
				name = "half_report_0000" + i;
			}else {
				name = "half_report_000" + i;
			}
			LogUtil.logd(WinLayout.logTag+ "initReportAnim: "+name);
	...
	private void initListeningAnim(){
		...
		for(int i =0;i < 15;i+=2){
			if (i < 10){
				name = "half_listening_0000" + i;
			}else {
				name = "half_listening_000" + i;
			}
			Drawable drawable = LayouUtil.getDrawable(name);
