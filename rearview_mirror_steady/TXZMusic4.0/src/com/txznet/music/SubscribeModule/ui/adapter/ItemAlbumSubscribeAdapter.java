...
public class ItemAlbumSubscribeAdapter extends ItemAlbumBaseAdapter {
    ...
    public void onChildBindViewHolder(RecyclerView.ViewHolder holder, Album album) {
        ...
        if (isEnterChoiceMode()) {
            ...
            if(ScreenUtils.isPhonePortrait()){
                viewHolder.getImageView().setAlpha(1F);
            }
    ...
    public RecyclerView.ViewHolder onCreateChildViewHolder(ViewGroup parent, int viewType) {
        View v;
        if (ScreenUtils.isPhonePortrait()) {
            v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_album_recommand_portrait, parent, false);
        }else{
            v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_album_recommand, parent, false);
        }
