...
public class PoiListView extends IPoiListView {
	...
	public void init() {
        ...
        centerInterval = (int) LayouUtil.getDimen("centerInterval");
        ...
        ivBusSide = (int) LayouUtil.getDimen("musicTagSide");
	...
	private void initFull(){
	    if (WinLayout.isVertScreen){
            ...
            tvContentSize = (int) LayouUtil.getDimen("vertical_h3");
            tvContentHeight = (int) LayouUtil.getDimen("vertical_h3_height");
    ...
    private void initNone(){
		if (WinLayout.isVertScreen){
			...
			tvContentSize = (int) LayouUtil.getDimen("x25");
			tvContentHeight = tvContentSize + 10;
			tvDistanceSize = (int) LayouUtil.getDimen("x18");
			tvDistanceHeight = tvDistanceSize + 10;
			tvDescSize = (int) LayouUtil.getDimen("x21");
			tvDescHeight = tvDescSize + 10;
			ivStarHeight = (int) LayouUtil.getDimen("x25");
            ivStarWidth = (int)(5.6 * ivStarHeight);
			tvPriceSize = (int) LayouUtil.getDimen("x21");
			centerInterval = (int) LayouUtil.getDimen("x3");
            ivBusSide = (int) LayouUtil.getDimen("x28");
		}else {
            int unit = (int) LayouUtil.getDimen("unit");
            tvNumSize = (int) LayouUtil.getDimen("h0");
	...
	private View createItemView(final RippleView itemView, final int position,Poi poi,boolean showDivider){
        ...
        llLayoutParams.rightMargin = ivBusRightMargin;
        llLayoutParams.gravity = Gravity.BOTTOM | Gravity.RIGHT;
