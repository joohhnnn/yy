...
public class AuthorizationView extends IAuthorizationView {
    ...
    private void initFull(){
        if (WinLayout.isVertScreen){
            ...
            titleHeight = 8 * unit;
            titleSize = (int) LayouUtil.getDimen("vertical_h4");
            ivSide = 17 * unit;
            tvSubTitleSize = (int) LayouUtil.getDimen("vertical_h7");
            tvSubTitleHeight = (int) LayouUtil.getDimen("vertical_h7_height");
            tvTipsLeftMargin = 3 * unit;
            tvTipsWidth = 36 * unit;
            tvTipsSize = (int) LayouUtil.getDimen("vertical_h5");
        }else{
            int unit = (int) LayouUtil.getDimen("unit");
            tvSubTitleTopMargin = unit;
            contentHeight = SizeConfig.pageCount * SizeConfig.itemHeight;
            titleHeight = 8 * unit;
            titleSize = (int) LayouUtil.getDimen("h4");
            ivSide = 20 * unit;
            tvSubTitleSize = (int) LayouUtil.getDimen("h7");
            tvSubTitleHeight = (int) LayouUtil.getDimen("h7_height");
            tvTipsLeftMargin = 3 * unit;
            tvTipsWidth = 35 * unit;
            tvTipsSize = (int) LayouUtil.getDimen("h5");
        }
    }
    ...
    private void initHalf(){
        if (WinLayout.isVertScreen){
            int unit = (int) LayouUtil.getDimen("vertical_unit");
            tvSubTitleTopMargin = unit;
            contentHeight = SizeConfig.pageCount * SizeConfig.itemHelpHeight;
            titleHeight = 8 * unit;
            titleSize = (int) LayouUtil.getDimen("vertical_h4");
            ivSide = 17 * unit;
            tvSubTitleSize = (int) LayouUtil.getDimen("vertical_h7");
            ...
            if(SizeConfig.screenHeight < 464){
                titleHeight = 6 * unit;
                titleSize = (int) LayouUtil.getDimen("h5");
                ivSide = 20 * unit;
                tvSubTitleSize = (int) LayouUtil.getDimen("h7");
                tvSubTitleHeight = (int) LayouUtil.getDimen("h7_height");
                tvTipsLeftMargin = 3 * unit;
                tvTipsWidth = 35 * unit;
                tvTipsSize = (int) LayouUtil.getDimen("h6");
            }else {
                titleHeight = 8 * unit;
                titleSize = (int) LayouUtil.getDimen("h4");
                ivSide = 20 * unit;
    ...
    private void initNone(){
        if (WinLayout.isVertScreen){
            tvSubTitleTopMargin = (int) LayouUtil.getDimen("x10");
            titleHeight = (int) LayouUtil.getDimen("x61");
            titleSize = (int) LayouUtil.getDimen("x25");
            ivSide = (int) LayouUtil.getDimen("x208");
            tvSubTitleSize = (int) LayouUtil.getDimen("x18");
            tvSubTitleHeight = tvSubTitleSize + 10;
            tvTipsLeftMargin = (int) LayouUtil.getDimen("x31");
            tvTipsWidth = (int) LayouUtil.getDimen("x365");
            tvTipsSize = (int) LayouUtil.getDimen("x23");
        }else{
            int unit = (int) LayouUtil.getDimen("unit");
            tvSubTitleTopMargin = unit;
            titleHeight = 6 * unit;
