...
public class PoiListView extends IPoiListView {
	...
	private static PoiListView sInstance = null;
	...
	protected PoiListView() {
		init();
	}

	public static PoiListView getInstance() {
		if (sInstance == null) {
			synchronized (PoiListView.class) {
				if (sInstance == null) {
					sInstance = new PoiListView();
				}
			}
		}
		return sInstance;
	...
	public ViewAdapter getView(ViewData data) {
		...
		isVertical = ScreenUtil.isVerticalDevice();
...
//		mMaxPage = poiListViewData.mTitleInfo.maxPage;
		...
		llLayout.setBackgroundColor(itemBgColor);
