...
copy /B /Y yzslibs\libvadnn_jni_rk.so   ..\..\assets\solibs\armeabi-v7a\libvadnn_jni_rk.so
...
copy /B /Y src\TXZSourceRecorderBase.java  ..\..\src\com\txznet\txz\util\recordcenter\TXZSourceRecorderBase.java

goto s2
if exist ..\..\src\com\unisound\common goto s1 
md ..\..\src\com\unisound\common
:s1
copy /B /Y src\v.java   ..\..\src\com\unisound\common\aa.java
