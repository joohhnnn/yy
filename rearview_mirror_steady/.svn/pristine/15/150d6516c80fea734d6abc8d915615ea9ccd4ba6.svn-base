...
public class ThreshHoldAdapter {
	...
	public static float getThreshValueFromV3(float value){
		...
		if (value > 70.0 - FLOAT_ACCURACY){//大于等于7.0时
			originVal = -1.3f;
		}else if (value > 60.0 - FLOAT_ACCURACY){//大于等于6.0时
			originVal = -1.5f;
		}else if (value > 50.0 - FLOAT_ACCURACY){//大于等于5.0时
			originVal = -1.7f;
		}else if (value > 40.0 - FLOAT_ACCURACY){//大于等于4.0时
			originVal = -1.9f;
		}else if (value > 30.0 - FLOAT_ACCURACY){//大于等于3.0时
			originVal = -2.1f;
		}else if (value > 25 - FLOAT_ACCURACY){//大于等于2.5时
			originVal = -2.2f;
		}else if (value > 20 - FLOAT_ACCURACY){//大于等于2.0时
			originVal = -2.3f;
		}else if (value > 15 - FLOAT_ACCURACY){//大于等于1.5时
			originVal = -2.4f;
		}else if (value > 10 - FLOAT_ACCURACY){//大于等于1.0时
			originVal = -2.5f;
