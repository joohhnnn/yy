...
//			itemView.setBackground(LayouUtil.getDrawable("list_item_bg"));
    ...
    private void initFull(){
        if (WinLayout.isVertScreen){
            ...
            tvContentSize = (int) LayouUtil.getDimen("vertical_h4");
            tvContentHeight = (int) LayouUtil.getDimen("vertical_h4_height");
            centerInterval = unit == 8?0:(int) LayouUtil.getDimen("centerInterval");
            centerInterval2 = (int) LayouUtil.getDimen("centerInterval");
            tvDistanceSize = (int) LayouUtil.getDimen("vertical_h7");
            tvDistanceHeight = (int) LayouUtil.getDimen("vertical_h7_height");
            tvDescSize = (int) LayouUtil.getDimen("vertical_h6");
            tvDescHeight = (int) LayouUtil.getDimen("vertical_h6_height");
            tvDescLeftMargin = unit;
            ivBusSide = (int) LayouUtil.getDimen("vertical_h1");
            ivBusRightMargin = unit / 2;
            ivStarHeight = (int) LayouUtil.getDimen(unit == 8?"vertical_h6":"vertical_h5");
            ivStarWidth = (int)(5.6 * ivStarHeight);
            tvPriceSize = (int) LayouUtil.getDimen("vertical_h6");
            ...
            tvContentSize = (int) LayouUtil.getDimen("h4");
            tvContentHeight = (int) LayouUtil.getDimen("h4_height");
            centerInterval = unit == 8?0:(int) LayouUtil.getDimen("centerInterval");
            centerInterval2 = (int) LayouUtil.getDimen("centerInterval");
            tvDistanceSize = (int) LayouUtil.getDimen("h7");
            tvDistanceHeight = (int) LayouUtil.getDimen("h7_height");
            tvDescSize = (int) LayouUtil.getDimen("h6");
            tvDescHeight = (int) LayouUtil.getDimen("h6_height");
            tvDescLeftMargin = unit;
            ivBusSide = (int) LayouUtil.getDimen("h1");
            ivBusRightMargin = unit / 2;
            ivStarHeight = (int) LayouUtil.getDimen(unit == 8?"h6":"h5");
            ivStarWidth = (int)(5.6 * ivStarHeight);
            tvPriceSize = (int) LayouUtil.getDimen("h6");
            historyLineHeight = 6 * unit;
            ivDeleteWidth = 3 * unit;
            ivDeleteHeight = 3 * unit;
            flDeleteWidth = 7 * unit;
    ...
    private void initNone(){
        if (WinLayout.isVertScreen){
            tvNumSide = (int) LayouUtil.getDimen("y37");
            tvNumHorMargin = (int) LayouUtil.getDimen("y6");
            tvNumSize = (int) LayouUtil.getDimen("vertical_h0");
            tvContentSize = (int) LayouUtil.getDimen("vertical_h4");
            tvContentHeight = (int) LayouUtil.getDimen("vertical_h4_height");
            centerInterval = (int) LayouUtil.getDimen("y1");
            centerInterval2 = (int) LayouUtil.getDimen("y1");
            tvDistanceSize = (int) LayouUtil.getDimen("vertical_h7");
            tvDistanceHeight = (int) LayouUtil.getDimen("vertical_h7_height");
            tvDescSize = (int) LayouUtil.getDimen("vertical_h6");
            tvDescHeight = (int) LayouUtil.getDimen("vertical_h6_height");
            tvDescLeftMargin = (int) LayouUtil.getDimen("y6");
            ivBusSide = (int) LayouUtil.getDimen("vertical_h1");
            ivBusRightMargin = (int) LayouUtil.getDimen("y3");
            ivStarHeight = (int) LayouUtil.getDimen("vertical_h6");
            ivStarWidth = (int)(5.6 * ivStarHeight);
            tvPriceSize = (int) LayouUtil.getDimen("vertical_h6");
            historyLineHeight = (int) LayouUtil.getDimen("y37");
            ivDeleteWidth =  (int) LayouUtil.getDimen("y18");
            ivDeleteHeight =  (int) LayouUtil.getDimen("y18");
            flDeleteWidth =  (int) LayouUtil.getDimen("y44");
        }else {
            int unit = (int) LayouUtil.getDimen("unit");
            tvNumSide = 6 * unit;
            tvNumHorMargin = unit;
            tvNumSize = (int) LayouUtil.getDimen("h0_none");
            tvContentSize = (int) LayouUtil.getDimen("h4_none");
            tvContentHeight = (int) LayouUtil.getDimen("h4_height_none");
            centerInterval = unit == 8?0:(int) LayouUtil.getDimen("centerInterval");
            centerInterval2 = (int) LayouUtil.getDimen("centerInterval");
            tvDistanceSize = (int) LayouUtil.getDimen("h7_none");
            tvDistanceHeight = (int) LayouUtil.getDimen("h7_height_none");
            tvDescSize = (int) LayouUtil.getDimen("h6_none");
            tvDescHeight = (int) LayouUtil.getDimen("h6_height_none");
            tvDescLeftMargin = unit;
            ivBusSide = (int) LayouUtil.getDimen("h1_none");
            ivBusRightMargin = unit / 2;
            ivStarHeight = (int) LayouUtil.getDimen(unit == 8?"h6_none":"h5_none");
            ivStarWidth = (int)(5.6 * ivStarHeight);
            tvPriceSize = (int) LayouUtil.getDimen("h6_none");
            historyLineHeight = 6 * unit;
            ivDeleteWidth = 3 * unit;
            ivDeleteHeight = 3 * unit;
            flDeleteWidth = 7 * unit;
