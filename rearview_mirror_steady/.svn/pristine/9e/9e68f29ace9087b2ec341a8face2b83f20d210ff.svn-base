...
//            ReportHelper.getInstance().sendReportData(ReqDataStats.Action.PAUSE_EXTERA);
    ...
    public void next(Operation operation) {
        ...
        ReportEvent.reportPlayEvent(type, PlayInfoManager.getInstance().getCurrentAudio(), PlayInfoManager.getInstance().getCurrentAlbum());
    ...
    public boolean isNextOperationLastTime() {
        return engine.isNextOperationLastTime();
    }
