...
public class WinLayoutFullV extends IWinLayout {
	...
	public static float weightRecord;    //动画部分布局权重
	public static float weightHint;    //引导语部分布局权重
	public static float weightContent;    //内容部分布局权重
	...
	private void initSize(){
		...
		tvHintMargin = 2 * unit;
		tvHintSize = (int) LayouUtil.getDimen("vertical_h6");
