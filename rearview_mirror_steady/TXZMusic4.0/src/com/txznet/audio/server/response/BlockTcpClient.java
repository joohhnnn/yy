...
import com.txznet.audio.server.dns.DnsState;
...
public abstract class BlockTcpClient {
    ...
    DnsState mDnsState = null;

    SocketChannel mSocketChannel = null;
    Selector mSelector = null;
    //TODO:减少大小，涨CPU，
    ByteBuffer mByteBufferRead = ByteBuffer.allocate(1024 * 8);
...
//            mDnsState = new DnsState(server);
//            byte[] bys = new byte[1024];
//            mDnsState.read(bys);
//            String ip = new String(bys);

            // TODO: 2018/6/15 管道的方式
...
//                    
//                }
//            }).subscribeOn(Schedulers.io()).observeOn(Schedulers.newThread()).subscribe(new Consumer<String>() {
//                @Override
