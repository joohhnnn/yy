...
public class PhotoFloatView extends WinDialog {
	...
	protected void onShow() {
		super.mDialog.getWindow().setLayout(mShowW, mShowH);
		super.mDialog.getWindow().setWindowAnimations(R.style.Animation_Translucent);
		super.onShow();
		ImageLoader.getInstance().displayImage("file://" + mUrl, mShow);
	}
