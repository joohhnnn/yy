...
import com.txznet.resholder.theme.ironman.rec.RecIronView2;
...
public class RecordView extends IRecordView {
	...
	private RecIronView2 mWaveView;
	...
	private void createRecordView() {
		...
		rlRecord.addOnAttachStateChangeListener(new OnAttachStateChangeListener() {
		...
		mWaveView = new RecIronView2(GlobalContext.get());
	...
	private void initLeftParams() {
		...
		RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams((int) LayouUtil.getDimen("x300"),
				RelativeLayout.LayoutParams.MATCH_PARENT);
		layoutParams.addRule(RelativeLayout.CENTER_IN_PARENT);
		rlRecord.addView(mWaveView, layoutParams);

		layoutParams = new RelativeLayout.LayoutParams(
				(int) ThemeConfigManager.getY(ThemeConfigManager.HELP_ICON_WIDTH),
				(int) ThemeConfigManager.getY(ThemeConfigManager.HELP_ICON_HEIGHT));
	...
	private void initBottomParams() {
		...
		layoutParams = new RelativeLayout.LayoutParams(
				(int) ThemeConfigManager
						.getY(ThemeConfigManager.HELP_ICON_WIDTH)/2,
				(int) ThemeConfigManager
						.getY(ThemeConfigManager.HELP_ICON_HEIGHT)/2);
